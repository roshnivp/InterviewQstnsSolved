...
/**
 * Created by vyompv on 7/26/2016.
 */
class Convert {
...
public class StringToInteger{
    public static void main(String[] args) {
        Convert sh=new Convert();
        String number= Convert.replaceNumbers("two hundred two million fifty three thousand point zero eight five eight oh two");
